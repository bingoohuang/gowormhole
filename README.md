...
详见 [cshare.go](cmd/gowormhole/cshare.go)
...
[godbtest](https://github.com/bingoohuang/godbtest)

```sh
$ godbtest gowormhole.db
> select * from gowormhole_recv;
2022/11/16 16:10:32 Connect to gowormhole.db succeed
2022/11/16 16:10:32 RunSQL: select * from gowormhole_recv
2022/11/16 16:10:32 Cost 76.453µs
+---+----------------------+----------+----------+--------------------------------------+--------------------------------------+------------------------+------------------------+-----------------+--------------------------------------------+--------+---------------+
